...
def draw(canvas):
    ...
    if (paddle1_pos < HEIGHT - PAD_HEIGHT and paddle1_vel > 0) or (paddle1_pos > 0 > paddle1_vel):
        paddle1_pos += paddle1_vel
    elif (paddle2_pos < HEIGHT - PAD_HEIGHT and paddle2_vel > 0) or (paddle2_pos > 0 > paddle2_vel):
        paddle2_pos += paddle2_vel

        # draw paddles
    canvas.draw_polygon([[0, paddle1_pos], [PAD_WIDTH, paddle1_pos], [PAD_WIDTH, paddle1_pos + PAD_HEIGHT],
                         [0, paddle1_pos + PAD_HEIGHT]], 1, "red", "white")
    canvas.draw_polygon(
        [[WIDTH, paddle2_pos], [WIDTH - PAD_WIDTH, paddle2_pos], [WIDTH - PAD_WIDTH, paddle2_pos + PAD_HEIGHT],
         [WIDTH, paddle2_pos + PAD_HEIGHT]], 1, "blue", "white")
